          ...
          <div className={styles.pricingContainer}>
            <div className={styles.pricingTable}>
              <Grid container spacing={4}>
                ...
                <Grid item xs={4}>
                  <Typography className={styles.titleCenter}>
                    {currentPricing.distance.firstTier}
                  </Typography>
                </Grid>
                <Grid item xs={4}>
                  <Typography className={styles.titleCenter}>
                    {currentPricing.distance.secondTier}
                  </Typography>
                </Grid>
              </Grid>
                  ...
                  <Grid container spacing={4} key={`${settingsIndex}`}>
                    ...
                    {setting["prices"].map((price, pricesIndex) => {
                      return (
                        <Grid
                          item
                          className={styles.gridAlignCenter}
                          key={`${settingsIndex}${pricesIndex}`}
                          xs={4}
                        >
                          <TextField
                            className={
