                ...
                return (
                  <div key={_id} className={styles.tableItem}>
                    ...
                    <div className={classNames(styles.item, styles.registered)}>
                      {registrationEndDate
                        ? getDateWithFormat(registrationEndDate, 'MM/DD/YYYY')
                        : getDateWithFormat(createdAt, 'MM/DD/YYYY')}
                    </div>
                    <div className={classNames(styles.item, styles.updated)}>
                      {getDateWithFormat(updatedAt, 'MM/DD/YYYY')}
                    </div>
                    ...
                    <div className={classNames(styles.item, styles.actions)}>
                      <Tooltip title="Reset password" placement="top" arrow>
                        <IconButton className={styles.action} onClick={() => onForgotUserPasswordModal(row)}>
                          <SVGIcon className={styles.userActionIcon} name={'passwordActive'} />
                        </IconButton>
                      </Tooltip>
