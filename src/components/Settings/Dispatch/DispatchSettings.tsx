...
export const DispatchSettings = ( props: DispatchSettingsProps ) => {
  ...
  const updateSettingGPEx = () => {
    ...
    if (valid(newSettingGP) && newSettingGP ) {
      setIsLoading(true)
      updateSettingGP(newSettingGP, objectId, typeObject).then((res) => {
    ...
    <div className={styles.contactForm}>
      ...
      <div className={styles.threeInput}>
        ...
        <div className={styles.textField}>
          ...
          />
          {errors.autoDispatchTimeframe ? <Error className={styles.errorAbsolute} value={errors.autoDispatchTimeframe}/> : null}
        </div>
        <div className={styles.textField}>
          <TextField
          ...
          />
          {errors.maxDeliveryLegDistance ? <Error className={styles.errorAbsolute} value={errors.maxDeliveryLegDistance}/> : null}
        </div>
      </div>
      ...
      <div className={styles.twoInput}>
        <div className={styles.textField}>
          ...
          />
          {errors.dispatchedBeforeClosingHours ? <Error className={styles.errorAbsolute} value={errors.dispatchedBeforeClosingHours}/> : null}
        </div>
      </div>
