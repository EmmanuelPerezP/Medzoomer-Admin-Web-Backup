...
export const TrainingVideo: FC = () => {
  ...
  const parseValues = () => {
    return {
      ...
      [SETTINGS.COURIER_COMMISSION_DELIVERY]: Number(
        settings[SETTINGS.COURIER_COMMISSION_DELIVERY]
      ),
      [SETTINGS.COURIER_TRANSACTION_FEE]: Number(
        settings[SETTINGS.COURIER_TRANSACTION_FEE]
      ),
      [SETTINGS.COURIER_COST_FOR_ONE_ORDER]: Number(
        settings[SETTINGS.COURIER_COST_FOR_ONE_ORDER]
      ),
      [SETTINGS.COURIER_COST_FOR_TWO_ORDER]: Number(
        settings[SETTINGS.COURIER_COST_FOR_TWO_ORDER]
      ),
      [SETTINGS.COURIER_COST_FOR_MORE_TWO_ORDER]: Number(
        settings[SETTINGS.COURIER_COST_FOR_MORE_TWO_ORDER]
      ),
      [SETTINGS.COURIER_COST_FOR_ML_IN_DELIVERY]: Number(
        settings[SETTINGS.COURIER_COST_FOR_ML_IN_DELIVERY]
      )
    };
  };
          ...
          <div className={styles.settingBlock}>
            <div className={styles.inputBlock}>
              {/* <div> */}
                ...
                />
                {err.training_video_link ? (
                  <Error
                    className={styles.error}
                    value={err.training_video_link}
                  />
                ) : null}
              {/* </div> */}
            </div>
