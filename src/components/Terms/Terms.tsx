      ...
      <div className={styles.textWrapper}>
        ...
        <div className={styles.article}>
          <Typography variant={'h6'} className={styles.text}>
            Medzoomer, LLC, a Limited Liability Company organized under the laws of the State of Florida and
            headquartered in Tampa (”Medzoomer” or “we” or “us” or “our”) welcomes you. References to Medzoomer include
            any subsidiaries or affiliates of Medzoomer involved with providing our Services. We invite you to access
            and use our Services (as defined below), which are made available to you through a variety of platforms,
            including www.MedZoomer.com and our mobile software application known as “Medzoomer” (referred to in these
        ...
        <ol className={styles.article}>
          <li>
            ...
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                Medzoomer is concerned about the safety and privacy of children. For this reason, you must be at least
                ...
                You acknowledge that Medzoomer does not direct the Platform or Services to children younger than 13
                years of age.
              </Typography>
            </div>
          </li>
          <li className={styles.article}>
            <Typography variant={'h6'} className={styles.text}>
              ...
              Subject to this Agreement and to any additional terms and conditions related to our App, Medzoomer hereby
          ...
          <li className={styles.nested}>
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                ...
                Medzoomer and its licensors, if any, own and retain all proprietary rights to Medzoomer, the Platform
                and Services, all software and other technology relating to the Platform and Services, and all text,
                images, data, information, and other content (collectively, the “Medzoomer Content”) including all
                ...
                Medzoomer and all rights are reserved to Medzoomer.
              </Typography>
            </div>
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                Medzoomer Content is protected under both United States and foreign laws and unauthorized use of
                Medzoomer Content may violate copyright, trademark, and other laws. Furthermore, elements of our
                ...
                limited to, the use of framing or mirrors. None of the Medzoomer Content may be retransmitted without
                our express, written consent for each and every instance. You have no rights in or to Medzoomer Content,
                and you may not use Medzoomer Content except as permitted under this Agreement. No other use is
                permitted without prior written consent from us. You must retain all copyright and other proprietary
                notices contained in the original Medzoomer Content. You may not sell, transfer, assign, license,
                sublicense, or modify Medzoomer Content or reproduce, display, publicly perform, make a derivative
                version of, distribute, or otherwise use Medzoomer Content in any way for any public or commercial
                purpose. The use or posting of Medzoomer Content on any other website or in a networked computer
            ...
            <ol>
              <li className={styles.article}>
                <Typography variant={'h6'} className={styles.text}>
                  Trademarks. The trademarks, service marks, and logos of Medzoomer (the “Medzoomer Trademarks”)
                  located, used, or displayed on the Platform or Services are registered and unregistered trademarks or
                  service marks of Medzoomer. Other company, product, and service names located, used, or displayed in
                  connection with the Platform or Services may be trademarks or service marks owned by third parties
                  (the “Third-Party Trademarks,” and, collectively with the Medzoomer Trademarks, the “Trademarks”). The
                  ...
                  used to disparage Medzoomer, any third party, or such third party’s products or services, or in any
                  manner that may damage any goodwill in the Trademarks. Use of any Trademarks as part of a link to or
                  from any site is prohibited unless Medzoomer approves the establishment of such a link by prior
                  written consent specific for each such link. All goodwill generated from the use of any Medzoomer
                  Trademark shall inure to Medzoomer’s benefit.
                </Typography>
              </li>
              <li className={styles.article}>
                <Typography variant={'h6'} className={styles.text}>
                  Patents; Copyrights. A number of issued patents and patents pending may apply to the Platform or
                  Services. The Platform and Services are also protected by copyrights owned by Medzoomer and/or third
                ...
                <Typography variant={'h6'} className={styles.text}>
                  ...
                  permission to access and use Medzoomer Content and the Platform and Services, and you must immediately
                  destroy any copies you have made of Medzoomer Content.
                </Typography>
              </li>
            </ol>
          </li>
          <li>
            ...
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                ...
                Platform or Services, you give Medzoomer and those we work with a worldwide, royalty-free, perpetual,
            ...
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                Medzoomer does not claim, and you do not transfer, any ownership rights in any of your User Generated
            ...
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                ...
                regulations. You further represent and warrant that the use of your User Generated Content by Medzoomer
            ...
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                ...
                may be disclosed through the Platform or Services to unknown persons and without control by Medzoomer.
              </Typography>
            </div>
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                You expressly acknowledge and agree that you, and not Medzoomer, are entirely responsible for User
            ...
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                ...
                permission to access and use Medzoomer Content and the Platform and Services.
              </Typography>
            </div>
          </li>
          <li>
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                ...
                Medzoomer or third parties (collectively, “Other Services”). You hereby acknowledge that use of our
            ...
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                Our Platform or Services might display content that is not Medzoomer’s. This content is the sole
          ...
          <li>
            ...
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                ...
                by the User. If Medzoomer notifies a User that the User’s access to our Platform or ability to use our
          ...
          <li className={styles.article}>
            <Typography variant={'h6'} className={styles.text}>
              ...
              (ii) your failure to comply with any terms or conditions of this Agreement or any Medzoomer policy, as
              determined by Medzoomer in its sole discretion, or (iii) your performance of any Prohibited Act described
              or defined herein. Medzoomer may terminate this Agreement at any time for any reason, with or without
          ...
          <li>
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                ...
                You expressly acknowledge and agree that (1) Medzoomer is not a pharmacy or healthcare provider; (2)
                Medzoomer does not provide any medical or other professional advice, opinion, diagnosis, or treatment,
                ...
                relationship between you and Medzoomer. You further expressly acknowledge and agree that your reliance
                on any information provided by Medzoomer is solely at your own risk.
              </Typography>
            </div>
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
            ...
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                Medzoomer does not recommend or endorse any specific products, services, physicians, tests, procedures,
          ...
          <li className={styles.article}>
            <Typography variant={'h6'} className={styles.text}>
              ...
              Medzoomer Preferred Network (a “Non-preferred Pharmacy”), we may offer you the option to have your
              prescription transferred to and filled at a pharmacy within the Medzoomer Preferred Network (a “Preferred
          ...
          <li className={styles.article}>
            <Typography variant={'h6'} className={styles.text}>
              ...
              MEDZOOMER DOES NOT ENDORSE OR RECOMMEND ANY PHARMACY, HEALTHCARE PROVIDER, OR PRESCRIPTION DRUG. MEDZOOMER
              ...
              THIRD PARTY. YOU ACKNOWLEDGE THAT IN NO EVENT SHALL MEDZOOMER BE LIABLE TO YOU OR ANY OTHER PARTY FOR ANY
          ...
          <li className={styles.article}>
            <Typography variant={'h6'} className={styles.text}>
              ...
              AVAILABLE” BASIS. NEITHER MEDZOOMER NOR ANY OF MEDZOOMER’S LICENSORS MAKE ANY EXPRESS REPRESENTATIONS OR
              ...
              OF VIRUSES OR HARMFUL CODES. WITHOUT LIMITING THE GENERALITY OF THE FOREGOING, NEITHER MEDZOOMER NOR ANY
              OF MEDZOOMER’S LICENSORS MAKE ANY WARRANTY THAT THE CONTENT OF PLATFORM OR SERVICES SATISFIES GOVERNMENT
              ...
              HARDWARE, THE NTERNET, AND ELECTRONIC COMMUNICATIONS. MEDZOOMER IS NOT RESPONSIBLE FOR ANY DELAYS,
              ...
              INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY OR PUNITIVE DAMAGES. IN NO EVENT SHALL MEDZOOMER
              ...
              GOD, OR ANY OTHER CAUSES BEYOND MEDZOOMER’S CONTROL. MEDZOOMER HEREBY EXPRESSLY DISCLAIMS ANY
              ...
              DIAGNOSING OR TREATING ANY MEDICAL CONDITION. MEDZOOMER HEREBY EXPRESSLY DISCLAIMS ANY LIABILITY FOR ANY
              INCORRECTLY PROCESSED PRESCRIPTIONS BY ANY PHARMACY OR ANY INACCURATE INFORMATION PROVIDED BY ANY USER OR
              BY ANY USER’S HEALTHCARE PROVIDER. MEDZOOMER HEREBY EXPRESSLY DISCLAIMS ANY LIABILITY FOR CANCELLED OR
          ...
          <li>
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                ...
                IF YOU ARE DISSATISFIED WITH THE PLATFORM OR SERVICES OR ANY OF MEDZOOMER’S TERMS, CONDITIONS, RULES,
                POLICIES, GUIDELINES, OR PRACTICES, OR OTHERWISE HAVE A DISPUTE WITH MEDZOOMER, YOUR SOLE AND EXCLUSIVE
                REMEDY IS TO TERMINATE THIS AGREEMENT AND DISCONTINUE USING OUR PLATFORM AND SERVICES. WITHOUT LIMITING
                THE GENERALITY OF THE FOREGOING, MEDZOOMER SHALL NOT BE LIABLE UNDER ANY CIRCUMSTANCES OR UNDER ANY
                ...
                PROVIDER, PHARMACY, OR OTHER PARTY UTILIZED THROUGH USE OF THE PLATFORM OR SERVICES, EVEN IF MEDZOOMER
                ...
                SERVICES, OR (D) ANY MATTERS BEYOND MEDZOOMER’S REASONABLE CONTROL. THE MAXIMUM AGGREGATE LIABILITY OF
                MEDZOOMER FOR ALL DAMAGES, LOSSES, LIABILITIES, COSTS AND EXPENSES UNDER ANY LEGAL THEORY, WHETHER IN
          ...
          <li>
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                ...
                You expressly acknowledge and agree that Medzoomer has no special relationship with or fiduciary duty to
                you and that Medzoomer has no control over any services provided to you by any pharmacy or healthcare
                ...
                against Medzoomer and its affiliates, officers, directors, employees, contractors, and licensors (the
            ...
            <div className={styles.article}>
              <Typography variant={'h6'} className={styles.text}>
                You agree to indemnify, defend, and hold harmless Medzoomer and its affiliates, officers, directors,
          ...
          <li className={styles.nested}>
            ...
            <ol>
              <li className={styles.article}>
                <Typography variant={'h6'} className={styles.text}>
                  Binding Arbitration. In the unlikely event that Medzoomer is unable to resolve your concerns, you
                  ...
                  Services (collectively, "Disputes") will be settled by binding arbitration between you and Medzoomer,
                  ...
                  Medzoomer are each waiving the right to a trial by jury or to participate as a plaintiff or class in
                  any purported class action or representative proceeding. Further, unless both you and Medzoomer
              ...
              <li className={styles.article}>
                <Typography variant={'h6'} className={styles.text}>
                  Arbitration Location and Procedure. Unless you and Medzoomer otherwise agree, the arbitration will be
                  conducted in Hillsborough County, Florida. If your claim does not exceed $10,000, then the arbitration
                  will be conducted solely on the basis of documents you and Medzoomer submit to the arbitrator, unless
              ...
              <li className={styles.article}>
                <Typography variant={'h6'} className={styles.text}>
                  ...
                  governed by the AAA rules, provided that if you are initiating an arbitration against Medzoomer and
                  the value of the relief sought is ten thousand dollars ($10,000) or less, then Medzoomer will advance
                  ...
                  costs and expenses would be prohibitively more expensive than a court proceeding, then Medzoomer will
                  ...
                  reimburse Medzoomer for all such costs and expenses that Medzoomer paid and that you would have been
              ...
              <li className={styles.article}>
                <Typography variant={'h6'} className={styles.text}>
                  Changes. Notwithstanding any modification-related provisions herein, if Medzoomer changes this
                  "Dispute Resolution" section after the date you first accepted this Agreement, or accepted any
                  subsequent changes to this Agreement, you may reject any such change by providing Medzoomer written
                  notice of such rejection by mail or hand delivery to: Medzoomer, LLC, Attn: CEO, 601 N. Ashley Dr,
                  Suite 1100-93591, Tampa, Florida 33602, or by email from the email address associated with your
                  account to Support@MedZoomer.com, within 30 days of the date such change became effective, as
                  ...
                  rejecting changes, you are agreeing that you will arbitrate any Dispute between you and Medzoomer in
            ...
            <ol>
              <li className={styles.article}>
                <Typography variant={'h6'} className={styles.text}>
                  ...
                  delivery service. If to Medzoomer, all notices shall be sent to Medzoomer, LLC Attn: CEO, 601 N.
                  Ashley Dr, Suite 1100-93591, Tampa, Florida 33602. If to a User, all notices shall be sent to the
                  User’s mailing address or email address provided to Medzoomer by the User when signing up to use the
                  ...
                  after deposit with such courier. Notices by Medzoomer to a User by email shall be deemed delivered
                  when received.
                </Typography>
              </li>
              <li className={styles.article}>
              ...
              <li className={styles.article}>
                <Typography variant={'h6'} className={styles.text}>
                  Waiver. No failure or delay by Medzoomer to insist upon the strict performance of any term, condition,
                  ...
                  preclude Medzoomer from exercising any such right, power, or remedy at any later time.
                </Typography>
              </li>
              <li className={styles.article}>
                <Typography variant={'h6'} className={styles.text}>
                  Assignment. Users may not assign this Agreement or any rights or obligations under this Agreement, by
                  operation of law or otherwise, without Medzoomer’s prior written consent. Medzoomer may assign this
              ...
              <li className={styles.article}>
                <Typography variant={'h6'} className={styles.text}>
                  Entire Agreement. This Agreement contains the entire agreement between Medzoomer and Users regarding
                  the terms of Users’ use of the Platform and Services and supersedes any prior written or oral
                  agreements between Medzoomer and any User.
                </Typography>
              </li>
              <li className={styles.article}>
                <Typography variant={'h6'} className={styles.text}>
                  Amendment. Medzoomer may amend, modify, or supplement (each, a “Change”) this Agreement at any time by
                  ...
                  by Medzoomer and a User. A User’s continued use of the Platform or Services following Medzoomer’s
